...
// UI Textures
 ...
 unsigned int youwon_tex;
 unsigned int lives_tex;
 unsigned int pac_happy;
 unsigned int life_tex;
 unsigned int score_tex;
 unsigned int paused_tex;
 unsigned int high_tex;
 unsigned int previous_tex;
 unsigned int pausehint_tex;
 unsigned int unpausehint_tex;
 unsigned int quithint_tex;
 unsigned int restarthint_tex;
...
// Fruit Textures
 ...
 void loadAndBindTextures()
 {
     ...
     pac_happy = load_and_bind_texture("sprites/pacman/h.png");
     ...
     youwon_tex = load_and_bind_texture("sprites/ui/youwon.png");
     life_tex = load_and_bind_texture("sprites/ui/life.png");
     lives_tex = load_and_bind_texture("sprites/ui/lives.png");
     score_tex = load_and_bind_texture("sprites/ui/score_tex.png");
     previous_tex = load_and_bind_texture("sprites/ui/previous.png");
     high_tex = load_and_bind_texture("sprites/ui/high.png");
     paused_tex = load_and_bind_texture("sprites/ui/paused.png");
     pausehint_tex = load_and_bind_texture("sprites/ui/pausehint.png");
     unpausehint_tex = load_and_bind_texture("sprites/ui/unpausehint.png");
     quithint_tex = load_and_bind_texture("sprites/ui/quithint.png");
     restarthint_tex = load_and_bind_texture("sprites/ui/restarthint.png");
